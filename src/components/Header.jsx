...
import Foto from "../Design_sem_nome__2_-removebg-preview.png"
  ...
  return (
    <AppBar position="static">
        <Container maxWidth="xl">
            ...
            <Grid item xs={2} md={2} sx={{ display: {lg:"none", xs:"block"}}}>
            <IconButton
              size="large"
            ...
            >
              ...
              <Grid item lg={2} xs={6} md={8}>
                <img src={Foto} />
              </Grid>
              <Grid item lg={8} md={10} sx={{display: {lg:"block", xs:"none"}}}>
                <Box>
              ...
              <Grid item lg={2} xs={4} md={2}>
                ...
                <Menu
                 ...
                 >
                  ...
                  <MenuItem onClick={handleCloseUserMenu}>
                  <Typography textAlign="center">Configuração</Typography>
                  </MenuItem>
                </Menu>
